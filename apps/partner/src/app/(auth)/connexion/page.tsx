  ...
  return (
    <div className="flex min-h-screen">
      {/* ─── Panneau gauche ───────────────────────────────────────────────
          ...
          Couche 2 : filigrane officiel tuilé
          Couche 3 : halo radial vert derrière le logo
          Couche 4 : bandes décoratives ivoiriennes (coins TL & BR)        */}
      <div
        className="relative hidden w-[42%] overflow-hidden lg:block"
      ...
      >
        ...
        <img
          ...
          alt=""
          aria-hidden
          className="pointer-events-none absolute left-0 top-0 w-[58%]"
          draggable={false}
        />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          ...
          alt=""
          aria-hidden
          className="pointer-events-none absolute bottom-0 right-0 w-[58%]"
          draggable={false}
        />
        ...
        <div className="relative z-10 flex h-full w-full flex-col items-center justify-center px-12">
          ...
          <img
            ...
            draggable={false}
          />
          <p className="mt-5 text-xl font-bold tracking-wide text-white">Espace Partenaire</p>
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-8 py-12 sm:px-14">
        <div className="w-full max-w-[400px]">
          <div className="mb-8 text-center lg:hidden">
            ...
            <p className="mt-1 text-sm text-gray-500">Espace Partenaire</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  placeholder="kone.issa@fivearena.ci"
                  value={email}
